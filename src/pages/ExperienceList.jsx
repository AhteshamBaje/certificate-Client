    ...
    return (
        <>
            ...
            <div className="flex justify-center mt-4">
                ...
                <button className='bg-slate-400 text-white hover:bg-slate-600 rounded-xl px-3 ml-2' onClick={searchExperience}>Search</button>
            </div>
                        ...
                        {filteredData.length > 0 ? filteredData.map((intern) => (
                            <tr key={intern._id} className="border hover:bg-gray-100 text-sm">
                                ...
                                <td className="border p-2 flex space-x-2">
                                    <button className="bg-blue-200 text-white hover:bg-green-600 px-2 py-1 rounded-md" onClick={() => navigate(`/experienceCertificate/${intern._id}`)}><svg className="w-5 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="none" viewBox="0 0 24 24">
